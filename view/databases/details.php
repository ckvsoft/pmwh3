    ...
    <div class="widget">
        ...
        <div class="widget-body">
                ...
                <table class="widget-table">
                    ...
                    <tbody>
                        <?php foreach ($users as $u):
                            $userEnc = urlencode((string) $u['username']);
                            $hostEnc = urlencode((string) $u['host']);
                        ?>
                            <tr>
                                ...
                                <?php if ($edit_perm): ?>
                                    <td>
                                        <form style="display:inline;" method="post"
                                              action="<?php echo BASE_URI; ?>pmwh3/databases/change_user_password/<?php echo $nameEnc; ?>/<?php echo $userEnc; ?>/<?php echo $hostEnc; ?>"
                                        ...
                                        <a href="<?php echo BASE_URI; ?>pmwh3/databases/delete_user/<?php echo $nameEnc; ?>/<?php echo $userEnc; ?>/<?php echo $hostEnc; ?>"
            ...
            <?php if ($edit_perm): ?>
                ...
                <form method="post" action="<?php echo BASE_URI; ?>pmwh3/databases/add_user/<?php echo $nameEnc; ?>">
                    <table class="widget-table">
                        <tr>
